...
Functionality
 - This code can recieve temperature data and fan speed set messages and display them on a web server.
 - It can also takes inputs of 0, 1, 2 or 3 from a web server and send it as a set fan speed message to the fan system.
 ...
 - Pass messages that the destination id is not it's own.
